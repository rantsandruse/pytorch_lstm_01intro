...
### 1. What is NLL (Negative log loss) Loss in pytorch? 
 ...
 <img src="https://render.githubusercontent.com/render/math?math=NLLLoss_{textbook}=-\sum_(y_i* log(p_i))">
 ...
 <img src="https://render.githubusercontent.com/render/math?math=NLLLoss_{pytorch}=-\sum_(y_i* x_i)">
...
<img src="https://render.githubusercontent.com/render/math?math=y=log\sum_(e^{x_i})=a %2B log\sum_(e^{x_i-a})">
