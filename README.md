...
standard softmax function is given as: 
   ...
   <img src="https://render.githubusercontent.com/render/math?math=$P_i=\frac{e^{-bi}}{\sum_{i=1}^{n}e^{-bi)}">
...
For training, we input the model, loss function of choice and a few other variables: 
